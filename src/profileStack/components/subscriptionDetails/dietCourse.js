...
export default function VideoCourse() {
  ...
  // const [diet, setDiet]=useState('Assist')
  ...
  //         <Text style={styles.rowTextHeader}>Dietician</Text>
  ...
  //       <Text style={styles.referText}>Select Dietician</Text>
  //       <TextInput style={styles.referText1}
  //                  defaultValue={diet} onChangeText={(text)=>setDietician(text)}/>
