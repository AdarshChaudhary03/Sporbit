...
//   const [curpackage, setCurPackage]=useState('P1');
//   const [physiotherapy, setPhysiotherapy] = useState('PH 2')
...
//           <Text style={styles.rowTextHeader}>Package</Text>
//           <Text style={styles.rowText}>{curpackage}</Text>
//         </View>
//         <View style={styles.rowBox}>
//           <Text style={styles.rowTextHeader}>Physiotherapy</Text>
//           <Text style={styles.rowText}>{physiotherapy}</Text>
//         </View>
...
//         <Text style={styles.referText}>Select Package</Text>
//         <TextInput style={styles.referText1}
//                    defaultValue={curpackage} onChangeText={(text)=>setCurPackage(text)}/>
//         <View style={styles.referCode}>
//           <Text style={styles.rowTextKey}>Change</Text>
//         </View>
//       </View>
//       <View style={styles.referralPara}>
//         <Text style={styles.referText}>Select Physiotherapy</Text>
//         <TextInput style={styles.referText1}
//                    defaultValue={physiotherapy} onChangeText={(text)=>setPhysiotherapy(text)}/>
//         <View style={styles.referCode}>
//           <Text style={styles.rowTextKey}>Change</Text>
//         </View>
//       </View>
